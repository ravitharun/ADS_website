...
// function About({req}) {
//     console.log(req,'req from the about')
//   useEffect(() => {
...
//       {/* About Section */}
//       <div
//         className="min-h-screen w-full text-white flex flex-col items-center justify-start pt-28 px-6 md:px-16 space-y-24 font-poppins"
//         style={{
...
//         {/* Team Section */}
//         <div className="w-full max-w-6xl flex flex-col space-y-24">
...
//                   />
//                   <div className="absolute inset-0 bg-black/20 rounded-2xl backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
//                 </div>
//               </div>

//               {/* Info */}
//               <div className="md:w-1/2 w-full flex flex-col justify-center backdrop-blur-lg bg-white/5 border border-white/10 p-6 rounded-2xl shadow-md">
//                 <h2
...
//         {/* Vision Section */}
//         <div
//           className="max-w-4xl text-center backdrop-blur-xl bg-white/5 p-8 rounded-2xl border border-white/10 shadow-lg"
//           data-aos="fade-up"
//         >
//           <h2
...
function About({ req }) {
  ...
  return (
    <>
      ...
      <div
        className="w-full text-white flex flex-col items-center justify-start pt-28 px-6 md:px-16 space-y-24 font-poppins"
        style={{
          background: "linear-gradient(135deg, #000000, #0a0a0a, #111111)",
        }}
      >
            ...
            >
              ...
              <div className="md:w-1/2 w-full flex flex-col justify-center backdrop-blur-lg bg-white/10 border border-white/10 p-8 rounded-2xl shadow-lg hover:shadow-blue-500/10 transition-all duration-300">
                <h2
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(45deg, #007aff, #9e9e9e)",
                  }}
                >
                  {member.name}
                </h2>
        ...
        {/* Vision Section */}
        <div
          className="max-w-4xl text-center backdrop-blur-xl bg-white/10 p-10 rounded-2xl border border-white/10 shadow-lg mb-16"
          data-aos="fade-up"
        >
          <h2
            className="text-4xl font-bold mb-4 bg-clip-text text-transparent"
